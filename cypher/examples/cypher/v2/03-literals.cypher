CREATE
  ...
  (`bob`)-[`e1`:`name` {`asserted`: true}]->(`lit_1`),
  (`bob`)-[`e2`:`age` {`asserted`: true}]->(`lit_2`),
  (`bob`)-[`e3`:`height` {`asserted`: true}]->(`lit_3`),
  (`bob`)-[`e4`:`score` {`asserted`: true}]->(`lit_4`),
  (`bob`)-[`e5`:`active` {`asserted`: true}]->(`lit_5`),
  (`bob`)-[`e6`:`born` {`asserted`: true}]->(`lit_6`);
