CREATE
  ...
  (`paper1`)-[`e1`:`rdf:type` {`asserted`: true}]->(`Article`),
  (`paper1`)-[`e2`:`title` {`asserted`: true}]->(`lit_1`),
  (`paper1`)-[`e3`:`author` {`asserted`: true}]->(`alice`),
  (`paper1`)-[`e4`:`author` {`asserted`: true}]->(`bob`),
  (`paper1`)-[`e5`:`publishedIn` {`asserted`: true}]->(`journal1`);
